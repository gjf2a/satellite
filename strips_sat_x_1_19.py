...
strips_sat_x_1_state.pointing = Oset([('satellite0','phenomenon12'),('satellite1','groundstation1'),('satellite2','groundstation2'),('satellite3','groundstation4'),('satellite4','planet15'),('satellite5','phenomenon11')])
strips_sat_x_1_state.power_avail = Oset(['satellite0','satellite1','satellite2','satellite3','satellite4','satellite5'])
...
strips_sat_x_1_goals.pointing = Oset([('satellite0','planet21'),('satellite2','star14'),('satellite5','planet17')])
